	...
	void test() {
		try (var emf = Persistence.createEntityManagerFactory("pc");
			...
			var operationOne = new Thread(() -> {
				...
				System.out.println(
						"Before operation one, amount of %s is %d.".formatted(account.getName(), account.getAmount()));
				...
				System.out.println(
						"After operation one, amount of %s is %d".formatted(account.getName(), account.getAmount()));
			...
			var operationTwo = new Thread(() -> {
				...
				System.out.println(
						"Before operation two, amount of %s is %d.".formatted(account.getName(), account.getAmount()));
				...
				System.out.println(
						"After operation two, amount of %s is %d".formatted(account.getName(), account.getAmount()));
