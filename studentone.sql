...
CREATE SCHEMA IF NOT EXISTS `one_db` DEFAULT CHARACTER SET utf8;

CREATE TABLE IF NOT EXISTS `one_db`.`address` (
...
CREATE TABLE IF NOT EXISTS `one_db`.`state` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `location` VARCHAR(255) NOT NULL,
  PRIMARY KEY(id))
ENGINE = InnoDB;

CREATE TABLE IF NOT EXISTS `one_db`.`contact` (
  `phone` VARCHAR(13) NOT NULL,
  `email` VARCHAR(100) NULL DEFAULT NULL,
  PRIMARY KEY (`phone`))
ENGINE = InnoDB;

CREATE TABLE IF NOT EXISTS `one_db`.`course` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `one_db`.`module` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(255) NOT NULL,
  ...
  CONSTRAINT `fk_module_course1`
    ...
    REFERENCES `one_db`.`course` (`id`))
ENGINE = InnoDB;

CREATE TABLE IF NOT EXISTS `one_db`.`student` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_student_address1`
    ...
    REFERENCES `one_db`.`address` (`id`),
 CONSTRAINT `fk_student_contact1`
    FOREIGN KEY (`contact_id`)
    REFERENCES `one_db`.`contact` (`phone`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

CREATE TABLE IF NOT EXISTS `one_db`.`registration` (
...
INSERT INTO `address` (`township`,`state_id`) VALUES
('Tamwe Township', 1),
('Bahan Township', 1),
('Ahlone Township', 1),
('Chanayethazan Township', 2),
('Aungmyethazan Township', 2),
('Mogok Township', 2),
('Pathein Township', 12),
('Hinthada Township', 12),
('Bogale Township', 12),
('Myitkyina Township', 9),
('Bhamo Township', 9),
('Myeik Township', 11),
('Dawei Township', 11),
('Kawthoung Township', 11),
('Hpa-An Township', 8),
('Myawaddy Township', 8),
('Loikaw Township', 10),
('Taunggyi Township', 7),
('Nyaung Shwe Township', 7),
('Lashio Township', 7),
('Kalaw Township', 7),
('Pyin Oo Lwin Township', 2),
('Mawlamyine Township', 5),
('Thaton Township', 5),
('Kyaikmaraw Township', 5),
('Sittwe Township', 3),
('Thandwe Township', 3),
('Mrauk U Township', 3),
('Magway Township', 4),
('Pakokku Township', 4),
('Chauk Township', 4),
('Naypyidaw Township', 6),
('Pyinmana Township', 6),
('Zabuthiri Township', 6),
('Yangon Downtown', 1),
('Thingangyun Township', 1),
('Hlaing Township', 1),
('Insein Township', 1),
('Dagon Township', 1);
